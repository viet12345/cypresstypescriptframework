...
import { GLOBAL_SELECTOR, SEARCH_SELECTOR } from '../../support/constants/pages/globalPage';
...
// Các case cần kiểm tra cho chức năng Tìm kiếm (Search)
describe('Kiểm tra với truy vấn không hợp lệ hoặc không có kết quả', () => {
    beforeEach('redirect to the login page by api', () => {
        cy.signinByApi(VALID_USER.USER, VALID_USER.PASSWORD);
    });

    describe('Cần có GUI riêng cho việc hiển thị No data', () => {
